...
from routers import (
    audio, checks, guessing, lingopause, messenger, misc, quiz, story, translate, worddrill,
)
...
for r in (story, audio, misc, checks, messenger, translate, guessing, quiz, worddrill, lingopause):
