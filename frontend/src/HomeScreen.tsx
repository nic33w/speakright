        ...
        <div style={{
          ...
          >
            ...
            <p style={{
              ...
              Battle an enemy by translating sentences! Choose easy, medium, or hard difficulty.
            </p>
          </button>
          ...
          {/* Guessing Game Card */}
          <button
            onClick={() => onSelectMode('guessing', fluent, learning)}
            style={{
              padding: '32px 24px',
          ...
          >
            ...
            <p style={{ fontSize: '14px', opacity: 0.9, lineHeight: '1.5' }}>
              I'll think of something, you ask yes/no questions to guess it!
            </p>
          </button>

          {/* Pronoun Blitz Card */}
          <button
            onClick={() => onSelectMode('pronounblitz', fluent, learning)}
            style={{
              padding: '32px 24px',
          ...
          >
            ...
            <p style={{ fontSize: '14px', opacity: 0.9, lineHeight: '1.5' }}>
              Watch a transfer animation, say the Spanish sentence with object pronouns in preterite!
            </p>
          </button>

          {/* Number Rush Card */}
          <button
            onClick={() => onSelectMode('numbers', fluent, learning)}
            style={{
              padding: '32px 24px',
